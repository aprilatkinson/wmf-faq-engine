...
const benefitRules: BenefitRule[] = [
  ...
  {
    patterns: [/handle type|fixed handle|soft[-\s]?touch|cool\+?/i],
    sourceFields: ['features'],
    createMapping: (text) => ({
      mechanism: 'A stable, ergonomic handle improves grip and control while cooking.',
      outcome: 'Makes it easier and safer to move or lift cookware.',
      use_case: 'Handling the pan during stovetop cooking or serving.',
      buyer_relevance: 'Provides a more comfortable cooking experience with better control.',
      source_confidence: HIGH,
    }),
  },
  {
